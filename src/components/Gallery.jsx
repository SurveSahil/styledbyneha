...
const allImages = [
  // Bridal
  { desktop: BridalA, mobile: BridalAMobile, alt: 'Bridal Look', category: 'Bridal', size: 'large' },
  ...
  // Party
  { desktop: Party, mobile: PartyMobile, alt: 'Party Makeup', category: 'Party', size: 'large' },
  { desktop: Party1, mobile: Party1Mobile, alt: 'Party Makeup', category: 'Party', size: 'normal' },
  { desktop: Party2, mobile: Party2Mobile, alt: 'Party Makeup', category: 'Party', size: 'normal' },
  { desktop: Party3, mobile: Party3Mobile, alt: 'Party Makeup', category: 'Party', size: 'large' },
  { desktop: Party4, mobile: Party4Mobile, alt: 'Party Makeup', category: 'Party', size: 'normal' },
  // Fashion
  { desktop: Fashion, mobile: FashionMobile, alt: 'Fashion Look', category: 'Fashion', size: 'large' },
  { desktop: Fashion1, mobile: Fashion1Mobile, alt: 'Fashion Look', category: 'Fashion', size: 'normal' },
  { desktop: Fashion2, mobile: Fashion2Mobile, alt: 'Fashion Look', category: 'Fashion', size: 'normal' },
  { desktop: Fashion3, mobile: Fashion3Mobile, alt: 'Fashion Look', category: 'Fashion', size: 'large' },
  { desktop: Fashion4, mobile: Fashion4Mobile, alt: 'Fashion Look', category: 'Fashion', size: 'normal' },
  { desktop: Fashion5, mobile: Fashion5Mobile, alt: 'Fashion Look', category: 'Fashion', size: 'normal' },
  // Hair
  { desktop: Hair1, mobile: Hair1Mobile, alt: 'Hairstyle', category: 'Hair', size: 'large' },
  { desktop: Hair2, mobile: Hair2Mobile, alt: 'Hairstyle', category: 'Hair', size: 'normal' },
  { desktop: Hair3, mobile: Hair3Mobile, alt: 'Hairstyle', category: 'Hair', size: 'normal' },
  { desktop: Hair4, mobile: Hair4Mobile, alt: 'Hairstyle', category: 'Hair', size: 'large' },
  { desktop: Hair5, mobile: Hair5Mobile, alt: 'Hairstyle', category: 'Hair', size: 'normal' },
  { desktop: Hair6, mobile: Hair6Mobile, alt: 'Hairstyle', category: 'Hair', size: 'normal' },
];
